                        ...
                        <div class="sc-3JRwrF-1 khjAih">
                            <div class="form-wrapper">
                                <div class="sc-2oZUsG bHHvBK">
                                    <form id="form">
                                        <div>
                                            <div class="sc-3ksGSP kPTEpp" type="mobileOrEmail"><label class="label">昵称</label>
                                            ...
                                            <div class="sc-3ksGSP kPTEpp" type="mobileOrEmail"><label class="label">手机号(登录账号)</label>
