                                ...
                                <div class="form-wrapper">
                                    ...
                                    <div class="sc-2oZUsG bHHvBK">
                                        ...
                                        <div>
                                            ...
                                            <form action="">
                                                <div class="sc-3ksGSP kPTEpp" type="mobileOrEmail"><label class="label">用户名(手机号)</label>
            ...
            doLogin:function(){
                ...
                Promise.all([new Promise((resolve , reject) => {
                    ...
                    if (results[0] && checkPhone  && checkPassword ){
                        let url = "/api/login/doLogin?phone=" + that.phone + "&password=" + that.password
                        axios.get(url).then(function (res) {
                            if (res.data.code === 100){
                                ...
                                that.$store.commit("changeisShowLogRegDialog")
