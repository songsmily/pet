    ...
    <div class="col center-part">
        <header class="bg-light lter wrapper-md">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>免疫证书上传</el-breadcrumb-item>
            </el-breadcrumb>
        </header>
        <!--内容页-->
...
<script>
    import {
        ...
        Select, Option, DatePicker,ButtonGroup
    } from "element-ui"
        ...
        methods: {
            ...
            doUpload: function () {
                ...
                new Promise((resolve, reject) => {
                    ...
                    if (res){
                        this.$Message.success("免疫证书上传成功,请等待管理员审核！")
                        setTimeout(function () {
            ...
            checkCardNumber: function () {
                if (this.petCard.cardNumber === undefined || this.petCard.cardNumber.length === 0) {
            ...
            cardImageUrl: function () {
                if (this.petCard.cardImageUrl === undefined || this.petCard.cardImageUrl.length === 0) {
