...
<script>
    ...
    import {Breadcrumb,Radio, BreadcrumbItem, Button, Cascader, DatePicker, InputNumber,Input,Autocomplete} from "element-ui"
    ...
    export default {
        ...
        mounted() {
            this.getOptions()
            this.hairColors = this.loadAll();
        },
        watch:{
            // "petInfo.petImageUrl":function () {
            //     this.checkImage()
            // },
            // "petInfo.petSex":function () {
            //     this.checkSex()
            // },
            // "petInfo.petType":function () {
            //     this.checkPetType()
            // }
        },
        methods: {
            ...
            handleAreaChange:function(val){
                this.petInfo.petType = this.$refs['location'].getCheckedNodes()[0].pathLabels[1]
                this.checkPetType()
