    ...
    <div class="col center-part">
        <header class="bg-light lter wrapper-md">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                <el-breadcrumb-item :to="'#'">消息中心</el-breadcrumb-item>
        ...
        <div class="wrapper-md" id="post-panel">
            ...
            <el-row v-infinite-scroll="load">
                <div v-if="this.$store.state.sysPetMessage.data.length > 0">
                    <el-col  v-for="(item,i) in this.$store.state.sysPetMessage.data" :span="24">
...
<script>
    ...
    export default {
        ...
        methods: {
            load: function () {
                this.$Loading.start()
                this.$util.returnMessage(this, true)
            },
